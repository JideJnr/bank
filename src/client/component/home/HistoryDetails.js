...
function HistoryDetails() {
  ...
  return (
    <div>
        ...
        <div className='w-screen h-full bg-[#eee]  overflow-y-auto '>
            ...
            <div className='w-full h-full '>
                ...
                <div className='bg-green-300 w-full  p-3 flex-col text-white'>
                    ...
                    <div className='w-full text-center   h-36 text-xl font-bold flex items-center justify-center'>

                        <div>
                        <p className='text-2xl '>{history.amount}</p>
                        <p className='text-xl '>SUCCESSFUL</p>
                        </div>
                ...
                <div className='flex-col w-full  p-3'>
                    ...
                    <div className='flex m-2 p-3 border-y border-y-white'>
                        <div>
                            <img src='' alt=''/>                    
                        </div>
                    ...
                    <div className='flex m-2 p-3 border-y border-y-white'>
                        ...
                        <div>
                            ...
                            <p className='font-medium'>{history.recRoute} </p>
